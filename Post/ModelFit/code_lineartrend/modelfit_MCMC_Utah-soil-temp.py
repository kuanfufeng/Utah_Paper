...
if __name__ == '__main__':
    ...
    output_imgdir = "../figure/Fitdv/MCMC_soil_temp"
    output_datadir = "../processed_fitdv_soil_temp/MCMC_sampler_{}_Normalized".format(nsteps)
    ...
    for stationpair in tqdm([stationpairs[i] for i in stationids]):
        ...
        labels = ["A","B","C","t_{shiftdays}","b_{lin}", "log(f)"]
